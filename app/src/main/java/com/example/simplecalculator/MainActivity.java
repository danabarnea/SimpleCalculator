...
import com.google.android.material.button.MaterialButton; // הוספת ייבוא של MaterialButton
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaterialButton signOut = findViewById(R.id.signout); // הוספת ה-MaterialButton כאן
